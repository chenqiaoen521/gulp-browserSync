...
var _lottery = __webpack_require__(129);
...
var _calulate = __webpack_require__(334);

var _calulate2 = _interopRequireDefault(_calulate);
...
var Lottery = function (_mix) {
  ...
  return Lottery;
}(mix(_base2.default, _calulate2.default, _interface2.default, _timer2.default));
  ...
  _createClass(Base, [{
    ...
    value: function initPlayList() {
      this.play_list.set('r2', {
        ...
        bonus: 26,
        tip: '从01~11中任选7个或多个号码，选号与开奖五个号相同，即中奖<em class="red">26</em>元',
        name: '任七'
      }).set('r8', {
        bonus: 9,
        tip: '从01~11中任选8个或多个号码，选号与开奖五个号相同，即中奖<em class="red">9</em>元',
        name: '任八'
      });
    }
    //初始化号码
    ...
    value: function setOmit(omit) {
      ...
      (0, _jquery2.default)(self.omit_el).each(function (i, e) {
    ...
    value: function addCodeItem(code, type, typeName, count) {
      var self = this;
      var tpl = '\n    <li codes="' + type + '|' + code + '" bonus="' + count + '" count="1">\n      <div class="code">\n        <b>' + typeName + (count > 1 ? '复试' : '单式') + '\u5355\u5F0F</b>\n        <b class="em">' + code + '</b>\n        [' + count + '\u6CE8,<em class="code-list-money">' + count * 2 + '</em>\u5143]\n      </div>\n    </li>\n    ';
    ...
    value: function getCount() {
      ...
      if (count === 0) {
        ...
        tpl = '\u60A8\u9009\u4E86 <b>' + count + '</b> \u6CE8\uFF0C\u5171 <b>' + count * 2 + '</b> \u5143 <em>\u82E5\u4E2D\u5956\uFF0C\u5956\u91D1\uFF1A\n      <strong class="red">' + range[0] + '</strong> \u81F3 <strong class="red">' + range[1] + '</strong> \u5143\uFF0C\u60A8\u5C06' + (win1 < 0 && win2 < 0 ? '亏损' : '盈利') + '\n      <strong class="' + (win1 >= 0 ? 'red' : 'green') + '">' + c1 + '</strong>\n      \u81F3 <strong class="' + (win2 >= 0 ? 'red' : 'green') + '">' + c1 + '</strong>\n      \u5143</em>\n      ';
      }
    ...
    value: function getTotal() {
      var count = 0;
      (0, _jquery2.default)('.codelist li').each(function (i, e) {
        count += (0, _jquery2.default)(e).attr('count') * 1;
      });
...
var Calulate = function () {
  function Calulate() {
    _classCallCheck(this, Calulate);
  }

  _createClass(Calulate, [{
    key: 'computeCount',
      ...
      if (play[0] === 'r') {
        ...
        if (min_active > 0) {
          if (min_active - play[1] >= 0) {
            ...
            min = Calulate.combine(arr, play[1]).length;
          } else {
            if (play[1] - 5 > 0 && active - play[1] >= 0) {
              arr = new Array(active - 5).fill(0);
              min = Calulate.combine(arr, play[1] - 5).length;
            } else {
        ...
        if (play[1] - 5 > 0) {
          if (active - play[1] >= 0) {
            arr = new Array(active - 5).fill(0);
            max = Calulate.combine(arr, play[1] - 5).length;
          } else {
            max = 0;
          }
        } else if (play[1] - 5 < 0) {
          arr = new Array(Math.min(active, 5)).fill(0);
          max = Calulate.combine(arr, play[1]).length;
        } else {
          max = 1;
        }
      }
